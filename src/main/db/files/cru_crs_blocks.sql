...
INSERT INTO cru_crs_blocks(id, page_id, block_type, admin_only, required, position, title, content) values('A229C444-6989-F658-7C29-B3DD-034F6FDB','707986E8-F4AD-4F6F-E0FD-D28C-2695B163','textQuestion',false, false, 0, 'Favorite poet','""');
INSERT INTO cru_crs_blocks(id, page_id, block_type, admin_only, required, position, title, content) values('A229C555-6989-F658-7C29-B3DD-034F6FDB','707986E8-F4AD-4F6F-E0FD-D28C-2695B163','numberQuestion',false, true, 1, 'Poems written in your life','""');
INSERT INTO cru_crs_blocks(id, page_id, block_type, admin_only, required, position, title, content) values('A229C666-6989-F658-7C29-B3DD-034F6FDB','707986E8-F4AD-4F6F-E0FD-D28C-2695B163','radioQuestion',false, false, 2, 'Preferred poetry style','{"choices" : ["Haiku","Limerick","Freestyle","Other"] }');
INSERT INTO cru_crs_blocks(id, page_id, block_type, admin_only, required, position, title, content) values('A229C777-6989-F658-7C29-B3DD-034F6FDB','707986E8-F4AD-4F6F-E0FD-D28C-2695B163','textQuestion',true, false, 3, 'Is capable poet?','""');

INSERT INTO cru_crs_blocks(id, page_id, block_type, admin_only, required, position, title, content) values('A727C854-6989-F658-7C29-B3DD-034F6FDB','ECB5B34F-D24D-83C8-2954-2179-AC4C38F2','textQuestion',false, false, 0, 'Favorite novel','""');
INSERT INTO cru_crs_blocks(id, page_id, block_type, admin_only, required, position, title, content) values('A728C555-6989-F658-7C29-B3DD-034F6FDB','ECB5B34F-D24D-83C8-2954-2179-AC4C38F2','numberQuestion',false, true, 1, 'Novels written in your life','""');
INSERT INTO cru_crs_blocks(id, page_id, block_type, admin_only, required, position, title, content) values('A729C666-6989-F658-7C29-B3DD-034F6FDB','ECB5B34F-D24D-83C8-2954-2179-AC4C38F2','radioQuestion',false, false, 2, 'Preferred poetry style','{"choices" : ["Mystery","Romance","Sci-fi","Other"] }');
INSERT INTO cru_crs_blocks(id, page_id, block_type, admin_only, required, position, title, content) values('A739C777-6989-F658-7C29-B3DD-034F6FDB','ECB5B34F-D24D-83C8-2954-2179-AC4C38F2','textQuestion',false, false, 3, 'Is capable author?','""');
