...
public class AnswerServiceTest
{
	...
	{
		AnswerEntity answer = getAnswerService().getAnswerBy(answerId);
	...
	{
		List<AnswerEntity> answers = getAnswerService().getAllAnswersForRegistration(registrationId);
	...
	{
		List<AnswerEntity> answers = getAnswerService().getAllAnswersForBlock(blockId);
